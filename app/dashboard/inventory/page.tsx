        ...
        {isLoading ? (
          ...
          data.length > 0 ? (
              ...
              return (
                <Card key={i._id} className="relative overflow-hidden border-none shadow-xl shadow-primary/5 bg-card/50 backdrop-blur-sm group transition-all hover:shadow-primary/10">
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="mt-4 text-lg">19kg Cylinders</CardTitle>
                    <CardDescription>Current stock in warehouse</CardDescription>
                  </CardHeader>
                  <CardContent>
            ...
            <div className="col-span-full text-center py-8 text-muted-foreground">
              No inventory data yet. Start by updating stock levels.
            </div>
          )
        )}
      </div>
